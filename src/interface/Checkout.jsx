function Checkout({onChangeInput, purchaseData}) {
    return (
        <div className="w-[70%]">
            <label htmlFor="card">Card Number</label>
            <input className="w-full p-[1rem] mb-5 normal-casetext-[1.7rem] text-xravel-color-black-6 normal-case border-[0.1rem] border-xravel-color-overlay-2 focus:border-xravel-color-orange-1" type="text" id="card" placeholder="enter your card number" value={purchaseData.card} onChange={(e) => onChangeInput(e, 'card')}  />  
            ...
            <div className="flex items-center gap-4 flex-wrap mt-5">
                ...
                <div className="w-full">
                    ...
                    <input className="w-full p-[1rem] normal-casetext-[1.7rem] text-xravel-color-black-6 normal-case border-[0.1rem] border-xravel-color-overlay-2 focus:border-xravel-color-orange-1" type="text" id="cvv" placeholder="978" value={purchaseData.cvv} onChange={(e) => onChangeInput(e, 'cvv')} />
                </div>        
            </div>
